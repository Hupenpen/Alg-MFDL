...
def save_embeddings(embeddings, output_path):
    np.savez(output_path, embeddings=np.array(list(embeddings.values())))
...
def main(input_path, output_path):
    ...
    print("Number of proteins processed:", len(results["protein_embs"]))
    save_embeddings(results["protein_embs"], output_path)

if __name__ == '__main__':
    input_path = 'path/to/input.fasta'  # Example: change to your input path
    output_path = 'path/to/output_embeddings.npz'  # Example: change to your output path

...
class CNN_Model(nn.Module):
    def __init__(self,input_channels):
        ...
        self.act = nn.ReLU()
        self.bigrucell = nn.GRU(1024, 64, num_layers=2, bidirectional=True)  # 双向GRU
...
class AttTransform_Model(nn.Module):
    def __init__(self,input_channels):
        ...
        self.conv1 = nn.Conv1d(input_channels, 256, kernel_size=3, padding=1)  # 3x3的一维卷积层
        self.conv2 = nn.Conv1d(256, 128, kernel_size=3, padding=1)  # 5x5的一维卷积层
        self.conv3 = nn.Conv1d(128, 64, kernel_size=3, padding=1)  # 7x7的一维卷积层
        self.bn1 = nn.BatchNorm1d(256)
        self.bn2 = nn.BatchNorm1d(128)
        self.bn3 = nn.BatchNorm1d(64)
        self.act = nn.ReLU()
